...
void				rotate_both_up(t_node **a, t_node **b,
						t_node *cheapest_node, t_config *config);
void				rotate_both_down(t_node **a, t_node **b,
						t_node *cheapest_node, t_config *config);
void				do_move(t_node **a, t_node **b, t_node *cheapest_node,
						t_config *config);
int					calculate_cost(int pos, int size);
void				rotate_a(t_node **a, t_node *cheapest_node,
						t_config *config);
void				rotate_b(t_node **a, t_node *cheapest_node,
						t_config *config);
